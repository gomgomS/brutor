...
class view_register_test:
    ...
    def _find_register_test(self, params):
        #PAGINATION
        page            = params["page"         ]
        ...
        # konten_list = []
        # konten_view = self.mgdDB.db_test.find(query).sort(order).skip(block_skip).limit(entry)
    ...
    def html(self, params):
        ...
        try:
            ...
            # FIND test
            test_resp              = self._find_register_test( params )            
            test_list              = test_resp["test_list"     ]
            block_count             = test_resp["block_count"     ]
            prev_button             = test_resp["prev_button"     ]
            next_button             = test_resp["next_button"     ]

            
            html = render_template(
                "register_test/register_test_list.html",
