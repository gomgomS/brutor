...
class view_users_tambah_form:
    ...
    def html(self, params):
        response = helper.response_msg(
            "FIND_USER_TAMBAH_FORM_SUCCESS", "FIND USER TAMBAH FORM SUCCESS", {} , "0000"
        )
        try:
            ...
            response.put( "status"      , "FIND_USER_TAMBAH_FORM_FAILED" )
            response.put( "desc"        , "FIND USER TAMBAH FORM FAILED" )
